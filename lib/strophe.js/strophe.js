...
import { DOMParser } from '../xmldom/dom-parser.js';
var window = {};
  ...
  (function (root, factory) {
    ...
    Strophe.Websocket.prototype = {
      ...
      _connect: function () {
        ...
        //加入微信websocket
        wx.connectSocket({ url: this._conn.service, protocols: ["xmpp"] });
        ...
        wx.onSocketError(function (res) {
          ...
          self.socket.onerror.call(self, res);
        });
      ...
      _closeSocket: function () {
        ...
        if (wxSocketOpen) {
          wx.closeSocket({
            success: e => { console.log(e); this.socket = null; },
